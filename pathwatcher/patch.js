...
// The final tarball will be created at pathwatcher-${version}.tgz

// Sample usage:
//     node pathwatcher/patch.js 8.1.0
...
if (process.argv.length < 3) {
	console.error("Please specify version, like 'node pathwatcher/patch.js 8.1.0'");
	return;
}
...
dnp({
    ...
    // Copy binary
    fs.copySync(path.resolve(__dirname, "binary"), path.resolve(BUILD_PW_DIR, "binary"));
	...
	exeProcess.then(function () {
		...
		var target = path.resolve(__dirname, tarball);

		// Move tarball to packs
