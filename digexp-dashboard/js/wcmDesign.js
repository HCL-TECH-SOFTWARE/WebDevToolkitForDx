                ...
                if (!stats.isDirectory()) {
                    ...
                    try{
                        ...
                        var wcmDesign =  {
                                ...
                                datePushed: utils.parseDate(libSettings.datePushed),
                                serverPushed: libSettings.serverPushed,
                                datePulled: utils.parseDate(libSettings.datePulled),
                                serverPulled: libSettings.serverPulled,
                                dateUpdated: utils.parseDate(libSettings.dateUpdated),
                                config: library
                        };
                        ...
                        if (!wcmDesign.dateUpdated) {
                          ...
                          if (wcmDesign.datePushed && wcmDesign.datePulled && wcmDesign.datePushed > wcmDesign.datePulled) {
