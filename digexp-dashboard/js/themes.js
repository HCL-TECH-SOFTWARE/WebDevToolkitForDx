    ...
    getThemes: function() {
      ...
      if (!fs.existsSync(themeFolder)) {
        ...
        fs.readdirSync(themeFolder).filter(isDir).forEach(function(file) {
          ...
          themeObjects[file].datePushed = utils.parseDate(themeInfo.datePushed);
          themeObjects[file].datePulled = utils.parseDate(themeInfo.datePulled);
          themeObjects[file].dateSynced = utils.parseDate(themeInfo.dateSynced);
