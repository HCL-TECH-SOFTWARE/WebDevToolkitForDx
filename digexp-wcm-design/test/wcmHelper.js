...
const TEST_USERNAME = config.TEST_USERNAME;
const TEST_PASSWORD = config.TEST_PASSWORD;
const TEST_HOST = config.TEST_HOST;
const TEST_PORT = config.TEST_PORT;
const TEST_CONTENT_HANDLER = config.TEST_CONTENT_HANDLER;
const TEST_NOT_SECURE = false;
const TEST_SECURE = true;
const TEST_SECURE_PORT = config.TEST_SECURE_PORT;
...
const LONG_TIMEOUT = config.LONG_TIMEOUT;
...
after(function() {
  fse.emptyDirSync(TESTING_FOLDER);
});
